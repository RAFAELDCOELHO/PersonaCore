...
| ERASE-01 / D2 | The discounted branch never rounds UP: `lock_erasure_floor(x) <= x * 0.60` exactly (W1) | unit | `pytest tests/test_phase19_erasure.py -k floor_rounding` | ❌ W0 | 19-03 |
