...
| 260902-fast-6 | README header image `assets/demo_personachat.png` (209 KB) converted to lossless WebP `assets/demo_personachat.webp` (68 KB), verified pixel-identical with PIL `ImageChops.difference`; README repointed, PNG removed. Motivation: user reported the header image loading slowly. Docs tests 21 passed. | 2026-09-02 | aead47d | inline (`/gsd-fast`, no directory) |
