...
the ``generate_text_cumulative`` Gradio-shaped adapter (08-02 / DEMO-01), and the id-space
``generate_text_from_ids`` / ``generate_text_from_ids_cumulative`` pair that streams from an
already-built prompt id list (14-01 / DEMO-07).
"""
