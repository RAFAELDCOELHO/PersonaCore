...
The single load-bearing constant here is ``GPT2_SPLIT_PATTERN``: the exact minbpe gpt2
regex that pre-splits text into word-like chunks BEFORE byte-level BPE runs, so merges
...
# Source: github.com/karpathy/minbpe regex.py gpt2 pat_str (CITED in 02-RESEARCH).
